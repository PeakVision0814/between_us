...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(find.textContaining('退出后，你们双方都会回到单人态'), findsWidgets);
  ...
  testWidgets('cancel in first exit confirmation dialog dismisses it', (
    tester,
  ) async {
    await _pumpSpaceStatus(tester);
  ...
  testWidgets('first confirm opens second confirmation dialog', (tester) async {
    await _pumpSpaceStatus(tester);
    ...
    // Second dialog body.
    expect(find.textContaining('确定要发起退出双人空间的请求吗'), findsOneWidget);
  ...
  testWidgets('cancel in second exit confirmation dialog dismisses it', (
    tester,
  ) async {
    await _pumpSpaceStatus(tester);
  ...
  testWidgets('self-requested exit shows waiting state', (tester) async {
  ...
  testWidgets('partner-requested exit shows approve button', (tester) async {
    await _pumpSpaceStatus(
      tester,
      initialExitRequest: const ExitRequestSnapshot(
        requestId: 'req-1',
  ...
  testWidgets('tapping approve shows confirmation dialog', (tester) async {
    ...
    expect(find.textContaining('同意后，双人空间将关闭'), findsOneWidget);
  ...
  testWidgets('cancel in approve dialog dismisses it', (tester) async {
    await _pumpSpaceStatus(
      tester,
      initialExitRequest: const ExitRequestSnapshot(
        requestId: 'req-1',
  ...
  testWidgets('confirming approve triggers exit and shows success', (
    tester,
  ) async {
