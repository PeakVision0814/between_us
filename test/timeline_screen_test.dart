...
void main() {
  ...
  testWidgets('single mode: notes tab shows empty state, no write button', (
    tester,
  ) async {
    await _pumpTimeline(tester);
  ...
  testWidgets('paired mode: plans page shows empty state and create button', (
    tester,
  ) async {
    await _pumpTimeline(
      tester,
  ...
  testWidgets('paired mode: notes tab shows empty state and write button', (
    tester,
  ) async {
    await _pumpTimeline(
      tester,
  ...
  testWidgets('paired mode: create plan dialog cancel closes dialog', (
    tester,
  ) async {
    await _pumpTimeline(
      tester,
  ...
  testWidgets('paired mode: mode switch hint is visible', (tester) async {
    await _pumpTimeline(
      tester,
      memberCount: 2,
      currentSpaceId: 'test-space-id',
  ...
  testWidgets('paired mode: switching to notes shows switch-to-plans hint', (
    tester,
  ) async {
    await _pumpTimeline(
      tester,
  ...
  testWidgets('paired mode: note section renders without errors', (
    tester,
  ) async {
    await _pumpTimeline(
      tester,
